...
VL_INLINE_OPT void Vriscv_top::_combo__TOP__5(Vriscv_top__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->o_riscv_dmem_rd_data = ((IData)(vlTOPp->o_riscv_dmem_wr_en)
                                    ...
                                    [(0x3fffU & (vlTOPp->o_riscv_dmem_addr 
                                                 >> 2U))]);
    if ((0U == (7U & (vlTOPp->o_riscv_imem_instr >> 0xcU)))) {
        vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data 
            = ((0xffffff00U & ((- (IData)((1U & (vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__u_riscv_dmem_interface__DOT__byte_aligned_dmem_rd_data 
                                                 >> 7U)))) 
                               << 8U)) | (0xffU & vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__u_riscv_dmem_interface__DOT__byte_aligned_dmem_rd_data));
    } else {
        if ((1U == (7U & (vlTOPp->o_riscv_imem_instr 
                          >> 0xcU)))) {
            vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data 
            ...
            if ((2U == (7U & (vlTOPp->o_riscv_imem_instr 
                              >> 0xcU)))) {
                vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data 
                    = vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__u_riscv_dmem_interface__DOT__byte_aligned_dmem_rd_data;
            } else {
                if ((4U == (7U & (vlTOPp->o_riscv_imem_instr 
                                  >> 0xcU)))) {
                    vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data 
                        = (0xffU & vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__u_riscv_dmem_interface__DOT__byte_aligned_dmem_rd_data);
                } else {
                    if ((5U == (7U & (vlTOPp->o_riscv_imem_instr 
                                      >> 0xcU)))) {
                        vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data 
