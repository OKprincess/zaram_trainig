...
void Vriscv_top::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[3U])) {
            tracep->chgIData(oldp+133,(vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data),32);
                                     ...
                                     ? ((0x4000U & vlTOPp->o_riscv_imem_instr)
                                         ...
                                         : ((0x2000U 
                                             ...
                                             : ((0x1000U 
                                                 ...
                                                 : 1U)))
                                     : 0xfU)),4);
        tracep->chgIData(oldp+156,(((IData)(4U) + vlTOPp->o_riscv_imem_pc)),32);
        tracep->chgIData(oldp+157,((vlTOPp->o_riscv_imem_pc 
