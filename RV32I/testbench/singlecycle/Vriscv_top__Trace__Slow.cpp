...
void Vriscv_top::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+134,"riscv_top u_riscv_cpu dmem_rd_data", false,-1, 31,0);
        ...
        tracep->declBus(c+134,"riscv_top u_riscv_cpu u_riscv_datapath i_dp_mem_rd_data", false,-1, 31,0);
        ...
        tracep->declBus(c+157,"riscv_top u_riscv_cpu u_riscv_datapath pc_plus_4", false,-1, 31,0);
        tracep->declBus(c+158,"riscv_top u_riscv_cpu u_riscv_datapath pc_plus_imm", false,-1, 31,0);
        ...
        tracep->declBus(c+157,"riscv_top u_riscv_cpu u_riscv_datapath u_riscv_adder_pc_plus_4 o_adder_sum", false,-1, 31,0);
        ...
        tracep->declBus(c+158,"riscv_top u_riscv_cpu u_riscv_datapath u_riscv_adder_pc_plus_imm o_adder_sum", false,-1, 31,0);
        ...
        tracep->declBus(c+134,"riscv_top u_riscv_cpu u_riscv_dmem_interface o_dmem_intf_rd_data", false,-1, 31,0);
...
void Vriscv_top::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+134,(vlTOPp->riscv_top__DOT__u_riscv_cpu__DOT__dmem_rd_data),32);
                                      ...
                                      ? ((0x4000U & vlTOPp->o_riscv_imem_instr)
                                          ...
                                          : ((0x2000U 
                                              ...
                                              : ((0x1000U 
                                                  ...
                                                  : 1U)))
                                      : 0xfU)),4);
        tracep->fullIData(oldp+157,(((IData)(4U) + vlTOPp->o_riscv_imem_pc)),32);
        tracep->fullIData(oldp+158,((vlTOPp->o_riscv_imem_pc 
