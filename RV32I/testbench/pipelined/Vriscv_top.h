...
VL_MODULE(Vriscv_top) {
  public:
    ...
    CData/*0:0*/ __Vclklast__TOP__riscv_top__i_clk;
  ...
  public:
    static void _combo__TOP__1(Vriscv_top__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _settle__TOP__3(Vriscv_top__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
